                  ...
                  <div className="w-full">
                    ...
                    >
                      <option value="Lab Testing">
                        Lab Testing - Soil, Aggregate, Bitumen, Emulsion, Steel
                        and more
                      </option>
                      <option value="Survey">
                        Survey - Auto-Level, Total Station, DGPS, Drone Survey
                        and more
                      </option>
                      <option value="DPR Preparation">
                        DPR Preparation - Estimation, Structure, Highway,
                        Bridge, Water Supply and more
                      </option>
                      <option value="Interior & Exterior Planning">
                        Interior & Exterior Planning - Residential, Commercial,
                        Institutional, Walkthrough and more
                      </option>
                      <option value="Third Party Inspection">
